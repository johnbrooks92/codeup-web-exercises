...
/*
    ...
    someArray.shift()   = removes first element     *mutates the array*
    someArray.unshift() = adds new first element    *mutates the array*
    someArray.pop()     = removes last element     *mutates the array*
    someArray.push()    = adds new last element     *mutates the array*
 */
...
// // returns the new total number of items in the array
// console.log(pies);
//
// // add element to end
//
// pies.push('chocolate');
// // again returns the new total number of items in the array
//
...
// RETURNS A COPIED SEGMENT OF THE ORIGINAL = ****DOES NOT MUTATE****
...
//
//
// // ============================= Split / Join *DOES NOT MUTATE THE ORIGINAL, MAKES A DUPLICATE*
//
...
function cleanPhoneNumbers(phoneNums) {
    var output = [];
//split input on new line character into an array of numbers
